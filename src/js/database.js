...
const killImagem = "./assets/imgs/metallica_killemall.jpg";
const blackImagem = "./assets/imgs/metallica_blackalbumn.jpg";
const rideImagem = "./assets/imgs/metallica_ridethelightning.jpg";

/* Músicas */

// Kill em All
const hitTheLights = "./audios/kill-em-all/hit-the-lights.mp3";
const theFourHorsemen = "./audios/kill-em-all/the-four-horsemen.mp3";
const motorbreath = "./audios/kill-em-all/motorbreath.mp3";
const jumpInTheFire = "./audios/kill-em-all/jump-in-the-fire.mp3";
const anesthesiaPullingTeeth = "./audios/kill-em-all/anesthesia-pulling-teeth.mp3";
const whiplash = "./audios/kill-em-all/whiplash.mp3";
const phantomLord = "./audios/kill-em-all/phantom-lord.mp3";
const noRemorse = "./audios/kill-em-all/no-remorse.mp3";
const seekDestroy = "./audios/kill-em-all/seek-n-destroy.mp3";
const metalMillitia = "./audios/kill-em-all/metal-militia.mp3";

// Black Album
const enterSandman = "./audios/black-album/enter-sandman.mp3";
const sadButTrue = "./audios/black-album/sad-but-true.mp3";
const holierThanThou = "./audios/black-album/holier-than-thou.mp3";
const theUnforgiven = "./audios/black-album/the-unforgiven.mp3";
const whereverIMayRoam = "./audios/black-album/wherever-i-may-roam.mp3";
const dontTreadOnMe = "./audios/black-album/dont-tread-on-me.mp3";
const throughTheNever = "./audios/black-album/through-the-never.mp3";
const nothingElseMatters = "./audios/black-album/nothing-else-matters.mp3";
const ofWolfAndMan = "./audios/black-album/of-wolf-and-man.mp3";
const myFriendOfMisery = "./audios/black-album/my-friend-of-misery.mp3";
const theStruggleWithin = "./audios/black-album/the-struggle-within.mp3";

// Ride the Lightning
const fightFireWithFire = "./audios/ride-the-lightning/fight-fire-with-fire.mp3";
const rideTheLightning = "./audios/ride-the-lightning/ride-the-lightning.mp3";
const forWhomTheBellTolls = "./audios/ride-the-lightning/for-whom-the-bell-tolls.mp3";
const fadeToBlack = "./audios/ride-the-lightning/fade-to-black.mp3";
const trappedUnderIce = "./audios/ride-the-lightning/trapped-under-ice.mp3";
const escape = "./audios/ride-the-lightning/escape.mp3";
const creepingDeath = "./audios/ride-the-lightning/creeping-death.mp3";
const theCallOfKtulu = "./audios/ride-the-lightning/the-call-of-ktulu.mp3";
